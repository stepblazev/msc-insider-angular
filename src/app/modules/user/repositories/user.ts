...
import {IProfileEditPayloadDTO, IProfileEditResponseDTO} from "../dto/profile-edit.dto";
...
export class UserRepository {
  ...
  public me() {
    return this._http.get<IUserMeResponseDTO>(
      `${BASE_URL}/api/v1/auth/me`,
    ).pipe(retry(2));
  }

  public changeProfilePhoto(formData: FormData) {
    return this._http.post<IChangePhotoResponseDTO>(
  ...
  public changeProfile(payload: IProfileEditPayloadDTO) {
    return this._http.post<IProfileEditResponseDTO>(
